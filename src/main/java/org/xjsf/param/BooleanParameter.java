...
/**
 * A Parameter whose values are booleans <p> If requests specify the parameter
 * name but not a value (e.g "serviceName?getImages") then we assume the value
 * is true. Otherwise, this ignores case variations, and can parse
 * 'true','false','t' or 'f'
 */

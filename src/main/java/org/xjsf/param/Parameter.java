...
/**
 * A parameter or argument for a service. Parameters should know how to extract
 * their value from an {@link HttpServletRequest} and document themselves as an
 * xml description.
 *
...
public abstract class Parameter<T> {
    ...
    /**
     * Returns the value to be used if no value is manually specified in the
     * service request. This may be null, in which case the parameter is
     * considered mandatory: all requests to the service must specify a value
     * for this parameter
     *
     * @return the value to be used if none is manually specified in the service
     * request.
     */
     ...
     * If the request specifies an invalid value, or none at all, then the
     * default value will be returned.
     *
     * @param request the request made to the service
     * @return the value of this parameter, as specified in the given request.
     * @throws IllegalArgumentException if the value specified in this request
     * cannot be parsed
     */
